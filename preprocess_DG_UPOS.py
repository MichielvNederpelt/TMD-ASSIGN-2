...
def add_features(conll_file):
    ...
    with open(conll_file[:-7] + '-feats.conllu', 'w', newline='', encoding='utf-8') as outputcsv:
        ...
        header = ['id', 'form', 'lemma', 'upos', 'xpos', 'head', 'deprel', 'NE_label', 'children', 'label']
        ...
        while conll_object != None:
            ...
            for i, row in enumerate(sentence_rows[:-1]): # skip final empty row
                ...
                if children:
                    row.insert(7, children) # insert list of children
                else:
                    row.insert(7,'O')
                if doc[i].text in entities_text:
                    idx = entities_text.index(doc[i].text)
                    row.insert(7, entities[idx].label_) # insert entity label
                else:
                    row.insert(7, 'O')
...
def is_predicate(row, predicates_in_sentence):
    ...
    elif predicates_in_sentence and (row[6] in ['xcomp', 'ccomp', 'parataxis', 'advcl'] or (row[6] == 'conj' and row[4] == 'VERB')) and row[6] in predicates_in_sentence:
        predicates_in_sentence.append(row[0])
        return True, predicates_in_sentence
...
def is_argument(predicate, row):
    ...
    '''
    if ('nsubj' in row[6] or 'obj' in row[6] or 'obl' in row[6]) and row[5] == predicate:
        return True
    return False

# and 'PRON' in row[3] and ('PRP$' or 'PRP' in row[4])
...
def preprocess_gold(conll_file):
    ...
    with open(conll_file[:-7] + '-prep.conllu', 'w', newline='', encoding='utf-8') as outputcsv:
        # write header
        csvwriter = csv.writer(outputcsv, delimiter='\t')
        header = ['id', 'form', 'lemma','upos', 'xpos', 'head', 'deprel', 'label']
        ...
        while conll_object != None:
            ...
            number_of_predicates = len(next_row)-8
            converted_cols = []
            for i in range(1, number_of_predicates+1):
                try:
                    target_col = next_row[7+i]
                    if target_col == '_':
                        target_col = 'O'
                    elif target_col == 'V':
                    ...
                    if 'CopyOf=' in next_row[7]:
                        idx = int(next_row[7].strip('CopyOf='))
                        target_col = list_of_sentence_rows[idx][7+i]
                converted_cols.append(target_col)
            extended_row = next_row[:7] + converted_cols
...
def squeeze_gold(conll_file):
    ...
    with open(conll_file[:-7] + '-squeeze.conllu', 'w', newline='', encoding='utf-8') as outputcsv:
        ...
        while conll_object != None:
            ...
            number_of_predicates = len(list_of_sentence_rows[0])-8
            for i in range(1, number_of_predicates+1):
                #print('predicate', i)
                for row in list_of_sentence_rows:
                    ...
                    try:
                        ...
                        if 'CopyOf=' in row[7]:
                            idx = int(row[7].strip('CopyOf='))
                            target_col = list_of_sentence_rows[idx][7+i]

                    extended_row = row[:7] + [target_col]
                    csvwriter.writerow(extended_row)
...
def preprocess_args(conll_file):
    ...
    with open(conll_file[:-7] + '-args.conllu', 'w', newline='', encoding='utf-8') as outputcsv:
        csvwriter = csv.writer(outputcsv, delimiter='\t')
        header = ['id', 'form', 'lemma','upos', 'xpos', 'head', 'deprel', 'NE_label', 'children', 'rb-predicate', 'rb-arg', 'label']
        csvwriter.writerow(header)
        next(conll_object)
          ...
          #  print('predicates in this sentence detected:', list_of_sentence_predicates)
            for i, row in enumerate(list_of_sentence_rows):
                ...
                if predicate_relations:
                    row.insert(10, 'RB_ARG:' + '-'.join(predicate_relations))
                else:
                    row.insert(10, 'O')
                #print(row)
                csvwriter.writerow(row)
...
path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-train.conllu"
sq_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-train-prep.conllu"
feature_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-train-prep-feats.conllu"
pred_path =r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-train-prep-feats-preds.conllu"

# path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-dev.conllu"
# sq_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-dev-prep.conllu"
# feature_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-dev-prep-feats.conllu"
# pred_path =r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-dev-prep-feats-preds.conllu"

# path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-test.conllu"
# sq_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-test-prep.conllu"
# feature_path = r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-test-prep-feats.conllu"
# pred_path =r"C:/Users/desir/desktop/text_mining/nlp_technology/UP_English-EWT/en_ewt-up-train-test-feats-preds.conllu"
