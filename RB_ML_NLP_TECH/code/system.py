...
#args = ['python','../../data/conll2003_ret.train-preprocessed_with_feats.conll', '../../data/conll2003_ret.test-preprocessed_chunks.conll', '../../models/1612_cl_fa_non_scaled_', r'../../models/\GoogleNews-vectors-negative300/GoogleNews-vectors-negative300.bin', False, True]
#main(args)
